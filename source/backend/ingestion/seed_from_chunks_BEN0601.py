...
CHUNKS_FILE = PROJECT_ROOT / "data_BEN0601" / "chunks_BEN0601" / "chunks_BEN0601.jsonl"
...
async def main() -> None:
    if not CHUNKS_FILE.exists():
        ...
        print("        Run the BEN0601 pipeline first.")
        return
