"""
test_marker_extraction_BEN0601.py

Smoke test for PDF extraction.
Runs extraction on the first PDF found in raw_BEN0601/, confirms Markdown output exists,
and prints the output path.

Usage (from project root):
    python source/backend/ingestion/test_marker_extraction_BEN0601.py
"""
...
def main() -> None:
    ...
    if not pdfs:
        ...
        print("       Add a PDF to data_BEN0601/raw_BEN0601/ and re-run.")
        sys.exit(1)
    ...
    from extract_with_marker_BEN0601 import extract_pdf
    import logging
