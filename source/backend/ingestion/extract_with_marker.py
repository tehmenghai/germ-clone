...
Converts all PDFs in data_01_raw/raw/ to Markdown using PyMuPDF.
Output goes to data_01_raw/marker_output/<pdf_stem>/<pdf_stem>.md
Logs success/failure to data_01_raw/logs/
...
Usage (from project root):
    python source/backend/ingestion/extract_with_marker.py
...
def main() -> None:
    ...
    if not pdfs:
        ...
        logger.error("Place at least one PDF in data_01_raw/raw/ and re-run.")
        sys.exit(1)
