"""
clean_marker_output_BEN0601.py

Cleans the PyMuPDF-extracted Markdown files in data_BEN0601/marker_output_BEN0601/
and writes cleaned versions to data_BEN0601/processed_BEN0601/
...
Usage (from project root):
    python source/backend/ingestion/clean_marker_output_BEN0601.py
"""
...
def main() -> None:
    ...
    for md_path in md_files:
        ...
        # Output name: <original_stem>_cleaned_BEN0601.md
        out_name = f"{md_path.stem}_cleaned_BEN0601.md"
